module uim.platform.mii.infrastructure.container;
...
struct Container {
    ...
    RunMiiIntegrationsUseCase runMiiIntegrationsUseCase;
    ...
    MiiHealthController healthController;
}
...
Container buildContainer(AppConfig config) {
    ...
    container.runMiiIntegrationsUseCase = new RunMiiIntegrationsUseCase(
        productRepo,
        specificationRepo,
    ...
    container.integrationController = new IntegrationController(container.runMiiIntegrationsUseCase);
    container.healthController = new MiiHealthController();
