module uim.platform.mii.application.usecases.manage.specifications;
...
class ManageSpecificationsUseCase : UIMUseCase {
    ...
    CommandResult create(SpecificationDTO dto) {
        ...
        if (!MiiValidator.isValidSpecification(value)) {
    ...
    CommandResult update(SpecificationDTO dto) {
        ...
        if (existing is null) {
            return CommandResult(false, "", "Alert notification not found");
        }
