module uim.platform.mii.presentation.http.controllers.specification;
...
class SpecificationController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        router.get("/api/v1/mii/alert-notifications", &handleList);
        router.get("/api/v1/mii/alert-notifications/*", &handleGet);
        router.post("/api/v1/mii/alert-notifications", &handleCreate);
        router.put("/api/v1/mii/alert-notifications/*", &handleUpdate);
        router.delete_("/api/v1/mii/alert-notifications/*", &handleDelete);
    }
    ...
    private void handleGet(scope HTTPServerRequest req, scope HTTPServerResponse res) {
        ...
        if (item is null) { writeError(res, 404, "Alert notification not found"); return; }
