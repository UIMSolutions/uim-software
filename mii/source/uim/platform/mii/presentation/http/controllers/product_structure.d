module uim.platform.mii.presentation.http.controllers.product_structure;
...
class ProductStructureController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        router.get("/api/v1/mii/integration-endpoints", &handleList);
        router.get("/api/v1/mii/integration-endpoints/*", &handleGet);
        router.post("/api/v1/mii/integration-endpoints", &handleCreate);
        router.put("/api/v1/mii/integration-endpoints/*", &handleUpdate);
        router.delete_("/api/v1/mii/integration-endpoints/*", &handleDelete);
    }
