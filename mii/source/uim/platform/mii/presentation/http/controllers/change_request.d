module uim.platform.mii.presentation.http.controllers.change_request;
...
class ChangeRequestController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        router.get("/api/v1/mii/data-collections", &handleList);
        router.get("/api/v1/mii/data-collections/*", &handleGet);
        router.post("/api/v1/mii/data-collections", &handleCreate);
        router.put("/api/v1/mii/data-collections/*", &handleUpdate);
        router.delete_("/api/v1/mii/data-collections/*", &handleDelete);
    }
