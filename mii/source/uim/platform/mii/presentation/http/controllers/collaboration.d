module uim.platform.mii.presentation.http.controllers.collaboration;
...
class CollaborationController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        router.get("/api/v1/mii/dashboard-widgets", &handleList);
        router.get("/api/v1/mii/dashboard-widgets/*", &handleGet);
        router.post("/api/v1/mii/dashboard-widgets", &handleCreate);
        router.put("/api/v1/mii/dashboard-widgets/*", &handleUpdate);
        router.delete_("/api/v1/mii/dashboard-widgets/*", &handleDelete);
    }
