module uim.platform.mii.presentation.http.controllers.recipe;
...
class RecipeController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        router.get("/api/v1/mii/workflow-instances", &handleList);
        router.get("/api/v1/mii/workflow-instances/*", &handleGet);
        router.post("/api/v1/mii/workflow-instances", &handleCreate);
        router.put("/api/v1/mii/workflow-instances/*", &handleUpdate);
        router.delete_("/api/v1/mii/workflow-instances/*", &handleDelete);
    }
