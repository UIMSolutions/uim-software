...
The architecture is inspired by SAP Engineering Control Center, which emphasizes digital orchestration of product development from design to operate, with integration toward SAP S/4HANA and related enterprise landscapes.
...
|---|---|---|
| Product Management | /api/v1/ecc/materials | Engineering teams |
| Product Structure | /api/v1/ecc/assembly-structures | Product architects |
| BOM Management | /api/v1/ecc/boms | Engineering and manufacturing planners |
| Change Management | /api/v1/ecc/change-requests | Configuration managers |
| Specification Management | /api/v1/ecc/document-attributes | Compliance and quality |
| Collaboration | /api/v1/ecc/workspaces | Cross-functional teams |
| Engineering Documents | /api/v1/ecc/documents | Technical documentation owners |
| Formulation | /api/v1/ecc/cad-items | Process development teams |
| Integration Orchestration | /api/v1/ecc/integrations/* | ERP and handover integration operators |
...
SAP Help Portal, SAP Engineering Control Center:
