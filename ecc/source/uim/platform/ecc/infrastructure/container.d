module uim.platform.ecc.infrastructure.container;
...
struct Container {
    ...
    RunEccIntegrationsUseCase runEccIntegrationsUseCase;
    ...
    EccHealthController healthController;
}
...
Container buildContainer(AppConfig config) {
    ...
    container.runEccIntegrationsUseCase = new RunEccIntegrationsUseCase(
        productRepo,
        specificationRepo,
    ...
    container.integrationController = new IntegrationController(container.runEccIntegrationsUseCase);
    container.healthController = new EccHealthController();
