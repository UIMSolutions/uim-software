module uim.platform.ecc.presentation.http.controllers.specification;
...
class SpecificationController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        router.get("/api/v1/ecc/document-attributes", &handleList);
        router.get("/api/v1/ecc/document-attributes/*", &handleGet);
        router.post("/api/v1/ecc/document-attributes", &handleCreate);
        router.put("/api/v1/ecc/document-attributes/*", &handleUpdate);
        router.delete_("/api/v1/ecc/document-attributes/*", &handleDelete);
    }
    ...
    private void handleGet(scope HTTPServerRequest req, scope HTTPServerResponse res) {
        ...
        if (item is null) { writeError(res, 404, "Specification not found"); return; }
