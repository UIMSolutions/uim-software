module uim.platform.ecc.presentation.http.controllers.collaboration;
...
class CollaborationController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        router.get("/api/v1/ecc/workspaces", &handleList);
        router.get("/api/v1/ecc/workspaces/*", &handleGet);
        router.post("/api/v1/ecc/workspaces", &handleCreate);
        router.put("/api/v1/ecc/workspaces/*", &handleUpdate);
        router.delete_("/api/v1/ecc/workspaces/*", &handleDelete);
    }
