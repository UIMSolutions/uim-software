module uim.platform.ecc.presentation.http.controllers.change_request;
...
class ChangeRequestController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        router.get("/api/v1/ecc/change-requests", &handleList);
        router.get("/api/v1/ecc/change-requests/*", &handleGet);
        router.post("/api/v1/ecc/change-requests", &handleCreate);
        router.put("/api/v1/ecc/change-requests/*", &handleUpdate);
        router.delete_("/api/v1/ecc/change-requests/*", &handleDelete);
    }
