module uim.platform.ecc.presentation.http.controllers.bill_of_material;
...
class BillOfMaterialController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        router.get("/api/v1/ecc/boms", &handleList);
        router.get("/api/v1/ecc/boms/*", &handleGet);
        router.post("/api/v1/ecc/boms", &handleCreate);
        router.put("/api/v1/ecc/boms/*", &handleUpdate);
        router.delete_("/api/v1/ecc/boms/*", &handleDelete);
    }
