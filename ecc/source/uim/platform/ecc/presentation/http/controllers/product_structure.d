module uim.platform.ecc.presentation.http.controllers.product_structure;
...
class ProductStructureController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        router.get("/api/v1/ecc/assembly-structures", &handleList);
        router.get("/api/v1/ecc/assembly-structures/*", &handleGet);
        router.post("/api/v1/ecc/assembly-structures", &handleCreate);
        router.put("/api/v1/ecc/assembly-structures/*", &handleUpdate);
        router.delete_("/api/v1/ecc/assembly-structures/*", &handleDelete);
    }
