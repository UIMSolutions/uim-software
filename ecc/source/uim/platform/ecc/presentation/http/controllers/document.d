module uim.platform.ecc.presentation.http.controllers.document;
...
class DocumentController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        router.get("/api/v1/ecc/documents", &handleList);
        router.get("/api/v1/ecc/documents/*", &handleGet);
        router.post("/api/v1/ecc/documents", &handleCreate);
        router.put("/api/v1/ecc/documents/*", &handleUpdate);
        router.delete_("/api/v1/ecc/documents/*", &handleDelete);
    }
