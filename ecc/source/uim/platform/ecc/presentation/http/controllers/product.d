module uim.platform.ecc.presentation.http.controllers.product;
...
class ProductController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        router.get("/api/v1/ecc/materials", &handleList);
        router.get("/api/v1/ecc/materials/*", &handleGet);
        router.post("/api/v1/ecc/materials", &handleCreate);
        router.put("/api/v1/ecc/materials/*", &handleUpdate);
        router.delete_("/api/v1/ecc/materials/*", &handleDelete);
    }
    ...
    private void handleGet(scope HTTPServerRequest req, scope HTTPServerResponse res) {
        ...
        if (item is null) { writeError(res, 404, "Product not found"); return; }
