module uim.platform.defemse.presentation.http.controllers.budget_triggers;
...
class BudgetTriggerController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        router.get("/api/v1/defemse/budget-triggers", &listAll);
        router.get("/api/v1/defemse/budget-triggers/*", &getOne);
        router.post("/api/v1/defemse/budget-triggers", &create);
        router.put("/api/v1/defemse/budget-triggers/*", &update);
        router.delete_("/api/v1/defemse/budget-triggers/*", &remove);
    }
