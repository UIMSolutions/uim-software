module uim.platform.defemse.presentation.http.controllers.maintenance_tasks;
...
class MaintenanceTaskController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        router.get("/api/v1/defemse/maintenance-tasks", &listAll);
        router.get("/api/v1/defemse/maintenance-tasks/*", &getOne);
        router.post("/api/v1/defemse/maintenance-tasks", &create);
        router.put("/api/v1/defemse/maintenance-tasks/*", &update);
        router.delete_("/api/v1/defemse/maintenance-tasks/*", &remove);
    }
