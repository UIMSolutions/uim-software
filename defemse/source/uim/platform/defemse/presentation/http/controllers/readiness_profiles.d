module uim.platform.defemse.presentation.http.controllers.readiness_profiles;
...
class ReadinessController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        router.get("/api/v1/defemse/readiness", &listAll);
        router.get("/api/v1/defemse/readiness/*", &getOne);
        router.post("/api/v1/defemse/readiness", &create);
        router.put("/api/v1/defemse/readiness/*", &update);
        router.delete_("/api/v1/defemse/readiness/*", &remove);
    }
