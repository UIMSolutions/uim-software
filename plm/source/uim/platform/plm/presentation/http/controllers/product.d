module uim.platform.plm.presentation.http.controllers.product;
...
class ProductController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        router.get("/api/v1/plm/products", &handleList);
        router.get("/api/v1/plm/products/*", &handleGet);
        router.post("/api/v1/plm/products", &handleCreate);
        router.put("/api/v1/plm/products/*", &handleUpdate);
        router.delete_("/api/v1/plm/products/*", &handleDelete);
    }
