module uim.platform.plm.presentation.http.controllers.change_request;
...
class ChangeRequestController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        router.get("/api/v1/plm/change-requests", &handleList);
        router.get("/api/v1/plm/change-requests/*", &handleGet);
        router.post("/api/v1/plm/change-requests", &handleCreate);
        router.put("/api/v1/plm/change-requests/*", &handleUpdate);
        router.delete_("/api/v1/plm/change-requests/*", &handleDelete);
    }
