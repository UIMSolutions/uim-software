module uim.platform.plm.presentation.http.controllers.collaboration;
...
class CollaborationController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        router.get("/api/v1/plm/collaborations", &handleList);
        router.get("/api/v1/plm/collaborations/*", &handleGet);
        router.post("/api/v1/plm/collaborations", &handleCreate);
        router.put("/api/v1/plm/collaborations/*", &handleUpdate);
        router.delete_("/api/v1/plm/collaborations/*", &handleDelete);
    }
