module uim.platform.plm.presentation.http.controllers.specification;
...
class SpecificationController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        router.get("/api/v1/plm/specifications", &handleList);
        router.get("/api/v1/plm/specifications/*", &handleGet);
        router.post("/api/v1/plm/specifications", &handleCreate);
        router.put("/api/v1/plm/specifications/*", &handleUpdate);
        router.delete_("/api/v1/plm/specifications/*", &handleDelete);
    }
