module uim.platform.plm.presentation.http.controllers.bill_of_material;
...
class BillOfMaterialController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        router.get("/api/v1/plm/boms", &handleList);
        router.get("/api/v1/plm/boms/*", &handleGet);
        router.post("/api/v1/plm/boms", &handleCreate);
        router.put("/api/v1/plm/boms/*", &handleUpdate);
        router.delete_("/api/v1/plm/boms/*", &handleDelete);
    }
