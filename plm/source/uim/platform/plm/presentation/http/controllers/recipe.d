module uim.platform.plm.presentation.http.controllers.recipe;
...
class RecipeController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        router.get("/api/v1/plm/recipes", &handleList);
        router.get("/api/v1/plm/recipes/*", &handleGet);
        router.post("/api/v1/plm/recipes", &handleCreate);
        router.put("/api/v1/plm/recipes/*", &handleUpdate);
        router.delete_("/api/v1/plm/recipes/*", &handleDelete);
    }
