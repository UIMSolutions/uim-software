module uim.platform.plm.presentation.http.controllers.document;
...
class DocumentController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        router.get("/api/v1/plm/documents", &handleList);
        router.get("/api/v1/plm/documents/*", &handleGet);
        router.post("/api/v1/plm/documents", &handleCreate);
        router.put("/api/v1/plm/documents/*", &handleUpdate);
        router.delete_("/api/v1/plm/documents/*", &handleDelete);
    }
