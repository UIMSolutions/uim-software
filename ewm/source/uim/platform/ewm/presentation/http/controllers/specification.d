...
*****************************************************************************************************************/
module uim.platform.ewm.presentation.http.controllers.specification;
...
class SpecificationController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        router.get("/api/v1/ewm/outbound-deliveries", &handleList);
        router.get("/api/v1/ewm/outbound-deliveries/*", &handleGet);
        router.post("/api/v1/ewm/outbound-deliveries", &handleCreate);
        router.put("/api/v1/ewm/outbound-deliveries/*", &handleUpdate);
        router.delete_("/api/v1/ewm/outbound-deliveries/*", &handleDelete);
    }
