...
*****************************************************************************************************************/
module uim.platform.ewm.presentation.http.controllers.document;
...
class DocumentController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        router.get("/api/v1/ewm/inbound-deliveries", &handleList);
        router.get("/api/v1/ewm/inbound-deliveries/*", &handleGet);
        router.post("/api/v1/ewm/inbound-deliveries", &handleCreate);
        router.put("/api/v1/ewm/inbound-deliveries/*", &handleUpdate);
        router.delete_("/api/v1/ewm/inbound-deliveries/*", &handleDelete);
    }
