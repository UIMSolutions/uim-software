module uim.platform.ewm.presentation.http.controllers.collaboration;
...
class CollaborationController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        router.get("/api/v1/ewm/resource-queues", &handleList);
        router.get("/api/v1/ewm/resource-queues/*", &handleGet);
        router.post("/api/v1/ewm/resource-queues", &handleCreate);
        router.put("/api/v1/ewm/resource-queues/*", &handleUpdate);
        router.delete_("/api/v1/ewm/resource-queues/*", &handleDelete);
    }
