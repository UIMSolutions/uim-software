...
*****************************************************************************************************************/
module uim.platform.ewm.presentation.http.controllers.product;
...
class ProductController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        router.get("/api/v1/ewm/warehouses", &handleList);
        router.get("/api/v1/ewm/warehouses/*", &handleGet);
        router.post("/api/v1/ewm/warehouses", &handleCreate);
        router.put("/api/v1/ewm/warehouses/*", &handleUpdate);
        router.delete_("/api/v1/ewm/warehouses/*", &handleDelete);
    }
    ...
    private void handleGet(scope HTTPServerRequest req, scope HTTPServerResponse res) {
        ...
        if (item is null) { writeError(res, 404, "Warehouse not found"); return; }
