...
*****************************************************************************************************************/
module uim.platform.asset_strategy_performance.application.usecases.manage.manage_failure_modes;
...
class ManageFailureModesUseCase : UIMUseCase {
    ...
    FailureMode[] listByModel(ModelId modelId) {
    ...
    CommandResult create(FailureModeDTO dto) {
        ...
        fm.equipmentId = dto.equipmentId;
        fm.name = dto.name;
        ...
        fm.occurrenceProbability = dto.occurrenceProbability;
        fm.detectability = dto.detectability;
        fm.createdBy = dto.createdBy;
        if (!StrategyValidator.isValidFailureMode(fm))
