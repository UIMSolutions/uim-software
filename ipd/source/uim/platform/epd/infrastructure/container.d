module uim.platform.epd.infrastructure.container;
...
struct Container {
    ...
    RunEpdIntegrationsUseCase runEpdIntegrationsUseCase;
    ...
    EpdHealthController healthController;
}
...
Container buildContainer(AppConfig config) {
    ...
    container.runEpdIntegrationsUseCase = new RunEpdIntegrationsUseCase(
        productRepo,
        specificationRepo,
    ...
    container.integrationController = new IntegrationController(container.runEpdIntegrationsUseCase);
    container.healthController = new EpdHealthController();
