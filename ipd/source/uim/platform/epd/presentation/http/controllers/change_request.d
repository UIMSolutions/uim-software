module uim.platform.epd.presentation.http.controllers.change_request;
...
class ChangeRequestController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        router.get("/api/v1/epd/change-requests", &handleList);
        router.get("/api/v1/epd/change-requests/*", &handleGet);
        router.post("/api/v1/epd/change-requests", &handleCreate);
        router.put("/api/v1/epd/change-requests/*", &handleUpdate);
        router.delete_("/api/v1/epd/change-requests/*", &handleDelete);
    }
