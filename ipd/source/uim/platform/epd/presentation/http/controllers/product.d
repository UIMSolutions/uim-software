module uim.platform.epd.presentation.http.controllers.product;
...
class ProductController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        router.get("/api/v1/epd/products", &handleList);
        router.get("/api/v1/epd/products/*", &handleGet);
        router.post("/api/v1/epd/products", &handleCreate);
        router.put("/api/v1/epd/products/*", &handleUpdate);
        router.delete_("/api/v1/epd/products/*", &handleDelete);
    }
