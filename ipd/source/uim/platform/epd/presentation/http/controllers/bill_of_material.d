module uim.platform.epd.presentation.http.controllers.bill_of_material;
...
class BillOfMaterialController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        router.get("/api/v1/epd/boms", &handleList);
        router.get("/api/v1/epd/boms/*", &handleGet);
        router.post("/api/v1/epd/boms", &handleCreate);
        router.put("/api/v1/epd/boms/*", &handleUpdate);
        router.delete_("/api/v1/epd/boms/*", &handleDelete);
    }
