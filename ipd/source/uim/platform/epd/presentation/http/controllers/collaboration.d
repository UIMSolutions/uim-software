module uim.platform.epd.presentation.http.controllers.collaboration;
...
class CollaborationController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        router.get("/api/v1/epd/collaborations", &handleList);
        router.get("/api/v1/epd/collaborations/*", &handleGet);
        router.post("/api/v1/epd/collaborations", &handleCreate);
        router.put("/api/v1/epd/collaborations/*", &handleUpdate);
        router.delete_("/api/v1/epd/collaborations/*", &handleDelete);
    }
