...
*****************************************************************************************************************/
module uim.platform.epd.presentation.http.controllers.specification;
...
class SpecificationController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        router.get("/api/v1/epd/specifications", &handleList);
        router.get("/api/v1/epd/specifications/*", &handleGet);
        router.post("/api/v1/epd/specifications", &handleCreate);
        router.put("/api/v1/epd/specifications/*", &handleUpdate);
        router.delete_("/api/v1/epd/specifications/*", &handleDelete);
    }
