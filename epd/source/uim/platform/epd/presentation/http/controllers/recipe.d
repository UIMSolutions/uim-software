module uim.platform.epd.presentation.http.controllers.recipe;
...
class RecipeController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        router.get("/api/v1/epd/recipes", &handleList);
        router.get("/api/v1/epd/recipes/*", &handleGet);
        router.post("/api/v1/epd/recipes", &handleCreate);
        router.put("/api/v1/epd/recipes/*", &handleUpdate);
        router.delete_("/api/v1/epd/recipes/*", &handleDelete);
    }
