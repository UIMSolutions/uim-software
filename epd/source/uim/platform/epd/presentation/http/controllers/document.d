module uim.platform.epd.presentation.http.controllers.document;
...
class DocumentController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        router.get("/api/v1/epd/documents", &handleList);
        router.get("/api/v1/epd/documents/*", &handleGet);
        router.post("/api/v1/epd/documents", &handleCreate);
        router.put("/api/v1/epd/documents/*", &handleUpdate);
        router.delete_("/api/v1/epd/documents/*", &handleDelete);
    }
