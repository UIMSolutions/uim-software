module uim.platform.epd.presentation.http.controllers.product_structure;
...
class ProductStructureController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        router.get("/api/v1/epd/product-structures", &handleList);
        router.get("/api/v1/epd/product-structures/*", &handleGet);
        router.post("/api/v1/epd/product-structures", &handleCreate);
        router.put("/api/v1/epd/product-structures/*", &handleUpdate);
        router.delete_("/api/v1/epd/product-structures/*", &handleDelete);
    }
