...
|---------|----------------|----------|
| Mission Planning | `/api/v1/defense/missions` | Planners and commanders |
| Exercise Management | `/api/v1/defense/exercises` | Training coordinators |
| Contingent Management | `/api/v1/defense/contingents` | Force managers |
| Readiness Management | `/api/v1/defense/readiness` | Operations staff |
| Redeployment Orchestration | `/api/v1/defense/redeployment-orders` | Logistics and transport planners |
...
│   └───────────────────────────────────────────────────┘   │
│                                                           │
│   ConfigMap: defense_HOST, defense_PORT                   │
│   Service: ClusterIP                                      │
└───────────────────────────────────────────────────────────┘
```
