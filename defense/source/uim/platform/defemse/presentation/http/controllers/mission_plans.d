module uim.platform.defense.presentation.http.controllers.mission_plans;
...
class MissionPlanController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        router.get("/api/v1/defense/missions", &listAll);
        router.get("/api/v1/defense/missions/*", &getOne);
        router.post("/api/v1/defense/missions", &create);
        router.put("/api/v1/defense/missions/*", &update);
        router.delete_("/api/v1/defense/missions/*", &remove);
    }
