module uim.platform.defense.presentation.http.controllers.exercises;
...
class ExerciseController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        router.get("/api/v1/defense/exercises", &listAll);
        router.get("/api/v1/defense/exercises/*", &getOne);
        router.post("/api/v1/defense/exercises", &create);
        router.put("/api/v1/defense/exercises/*", &update);
        router.delete_("/api/v1/defense/exercises/*", &remove);
    }
