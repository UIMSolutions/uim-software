module uim.platform.defense.presentation.http.controllers.redeployment_orders;
...
class RedeploymentOrderController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        router.get("/api/v1/defense/redeployment-orders", &listAll);
        router.get("/api/v1/defense/redeployment-orders/*", &getOne);
        router.post("/api/v1/defense/redeployment-orders", &create);
        router.put("/api/v1/defense/redeployment-orders/*", &update);
        router.delete_("/api/v1/defense/redeployment-orders/*", &remove);
    }
