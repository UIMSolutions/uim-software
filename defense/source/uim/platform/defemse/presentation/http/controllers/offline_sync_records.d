module uim.platform.defense.presentation.http.controllers.offline_sync_records;
...
class OfflineSyncRecordController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        router.get("/api/v1/defense/offline-sync-records", &listAll);
        router.get("/api/v1/defense/offline-sync-records/*", &getOne);
        router.post("/api/v1/defense/offline-sync-records", &create);
        router.put("/api/v1/defense/offline-sync-records/*", &update);
        router.delete_("/api/v1/defense/offline-sync-records/*", &remove);
    }
