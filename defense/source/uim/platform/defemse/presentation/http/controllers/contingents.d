module uim.platform.defense.presentation.http.controllers.contingents;
...
class ContingentController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        router.get("/api/v1/defense/contingents", &listAll);
        router.get("/api/v1/defense/contingents/*", &getOne);
        router.post("/api/v1/defense/contingents", &create);
        router.put("/api/v1/defense/contingents/*", &update);
        router.delete_("/api/v1/defense/contingents/*", &remove);
    }
