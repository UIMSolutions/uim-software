module uim.platform.ppm.infrastructure.persistence.postgres.migrations;

import uim.platform.ppm.infrastructure.persistence.postgres.common;

@safe:

enum string PPM_SCHEMA_SQL = q"EOSQL
...
void ensurePpmSchema(string connectionString) {
    auto runner = PostgresSqlRunner(connectionString);
    runner.exec(PPM_SCHEMA_SQL);
}
