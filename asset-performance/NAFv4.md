# NAF v4 Architecture Views - Asset Performance Management Service

NATO Architecture Framework v4 (NAFv4) views for the Asset Performance Management Service, modeled after SAP Asset Performance Management (SAP ASPM).

## C1 - Capability Taxonomy

```mermaid
graph TB
    ASPM[Asset Performance Management]
...
The Asset Performance Management Service provides a comprehensive platform for managing asset maintenance strategies, failure analysis, and performance monitoring. It enables:
...
graph TB
    subgraph Compute["Compute Resources"]
        ...
        BIN[Binary: uim-asset-performance-platform-service]
    end
...
graph TB
    ...
    subgraph Config["Configuration"]
        HOST["ASSET_PERFORMANCE_HOST=0.0.0.0"]
        PORT["ASSET_PERFORMANCE_PORT=8105"]
    end
...
```mermaid
graph TB
    ASPM[Asset Performance Management Service]
