...
*****************************************************************************************************************/
module uim.software.asset_performance.infrastructure.persistence.repositories.functions;
...
class MemoryFunctionRepository : FunctionRepository {
    ...
    @trusted Function* findById(FunctionId id) {
        foreach (idx, ref f; store)
            if (f.id == id) return &store[idx];
        return null;
    }
