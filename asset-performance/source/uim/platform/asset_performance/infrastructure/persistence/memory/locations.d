...
*****************************************************************************************************************/
module uim.software.asset_performance.infrastructure.persistence.repositories.locations;
...
class MemoryLocationRepository : LocationRepository {
    ...
    @trusted Location* findById(LocationId id) {
        foreach (idx, ref l; store)
            if (l.id == id) return &store[idx];
        return null;
    }
