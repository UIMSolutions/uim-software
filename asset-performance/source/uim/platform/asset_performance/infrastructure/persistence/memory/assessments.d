...
*****************************************************************************************************************/
module uim.software.asset_performance.infrastructure.persistence.repositories.assessments;
...
class MemoryAssessmentRepository : AssessmentRepository {
    ...
    @trusted Assessment* findById(AssessmentId id) {
        foreach (idx, ref a; store)
            if (a.id == id) return &store[idx];
        return null;
    }
