...
*****************************************************************************************************************/
module uim.software.asset_performance.presentation.http.controllers.function_;
...
class FunctionController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        ...
        router.get("/api/v1/asset-performance/functions", &handleList);
        router.get("/api/v1/asset-performance/functions/*", &handleGet);
        router.post("/api/v1/asset-performance/functions", &handleCreate);
        router.put("/api/v1/asset-performance/functions/*", &handleUpdate);
        router.delete_("/api/v1/asset-performance/functions/*", &handleDelete);
    }
