...
*****************************************************************************************************************/
module uim.software.asset_performance.presentation.http.controllers.model;
...
class ModelController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        ...
        router.get("/api/v1/asset-performance/models", &handleList);
        router.get("/api/v1/asset-performance/models/*", &handleGet);
        router.post("/api/v1/asset-performance/models", &handleCreate);
        router.put("/api/v1/asset-performance/models/*", &handleUpdate);
        router.delete_("/api/v1/asset-performance/models/*", &handleDelete);
    }
