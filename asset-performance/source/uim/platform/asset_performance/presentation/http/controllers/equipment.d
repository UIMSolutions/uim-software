...
*****************************************************************************************************************/
module uim.software.asset_performance.presentation.http.controllers.equipment;
...
class EquipmentController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        ...
        router.get("/api/v1/asset-performance/equipment", &handleList);
        router.get("/api/v1/asset-performance/equipment/*", &handleGet);
        router.post("/api/v1/asset-performance/equipment", &handleCreate);
        router.put("/api/v1/asset-performance/equipment/*", &handleUpdate);
        router.delete_("/api/v1/asset-performance/equipment/*", &handleDelete);
    }
