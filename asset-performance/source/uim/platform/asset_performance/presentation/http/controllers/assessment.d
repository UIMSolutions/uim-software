...
*****************************************************************************************************************/
module uim.software.asset_performance.presentation.http.controllers.assessment;
...
class AssessmentController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        ...
        router.get("/api/v1/asset-performance/assessments", &handleList);
        router.get("/api/v1/asset-performance/assessments/*", &handleGet);
        router.post("/api/v1/asset-performance/assessments", &handleCreate);
        router.put("/api/v1/asset-performance/assessments/*", &handleUpdate);
        router.delete_("/api/v1/asset-performance/assessments/*", &handleDelete);
    }
