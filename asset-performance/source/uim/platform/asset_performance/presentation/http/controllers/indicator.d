...
*****************************************************************************************************************/
module uim.software.asset_performance.presentation.http.controllers.indicator;
...
class IndicatorController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        ...
        router.get("/api/v1/asset-performance/indicators", &handleList);
        router.get("/api/v1/asset-performance/indicators/*", &handleGet);
        router.post("/api/v1/asset-performance/indicators", &handleCreate);
        router.delete_("/api/v1/asset-performance/indicators/*", &handleDelete);
    }
