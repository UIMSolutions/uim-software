...
*****************************************************************************************************************/
module uim.software.asset_performance.presentation.http.controllers.failure_mode;
...
class FailureModeController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        ...
        router.get("/api/v1/asset-performance/failure-modes", &handleList);
        router.get("/api/v1/asset-performance/failure-modes/*", &handleGet);
        router.post("/api/v1/asset-performance/failure-modes", &handleCreate);
        router.put("/api/v1/asset-performance/failure-modes/*", &handleUpdate);
        router.delete_("/api/v1/asset-performance/failure-modes/*", &handleDelete);
    }
