...
*****************************************************************************************************************/
module uim.software.asset_performance.presentation.http.controllers.location;
...
class LocationController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        ...
        router.get("/api/v1/asset-performance/locations", &handleList);
        router.get("/api/v1/asset-performance/locations/*", &handleGet);
        router.post("/api/v1/asset-performance/locations", &handleCreate);
        router.put("/api/v1/asset-performance/locations/*", &handleUpdate);
        router.delete_("/api/v1/asset-performance/locations/*", &handleDelete);
    }
