...
*****************************************************************************************************************/
module uim.software.asset_performance.presentation.http.controllers.instruction;
...
class InstructionController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        ...
        router.get("/api/v1/asset-performance/instructions", &handleList);
        router.get("/api/v1/asset-performance/instructions/*", &handleGet);
        router.post("/api/v1/asset-performance/instructions", &handleCreate);
        router.put("/api/v1/asset-performance/instructions/*", &handleUpdate);
        router.delete_("/api/v1/asset-performance/instructions/*", &handleDelete);
    }
