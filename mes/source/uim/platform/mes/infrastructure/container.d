module uim.platform.mes.infrastructure.container;
...
struct Container {
    ...
    RunMesIntegrationsUseCase runMesIntegrationsUseCase;
    ...
    MesHealthController healthController;
}
...
Container buildContainer(AppConfig config) {
    ...
    container.runMesIntegrationsUseCase = new RunMesIntegrationsUseCase(
        productRepo,
        specificationRepo,
    ...
    container.integrationController = new IntegrationController(container.runMesIntegrationsUseCase);
    container.healthController = new MesHealthController();
