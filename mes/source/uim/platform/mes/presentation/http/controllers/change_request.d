module uim.platform.mes.presentation.http.controllers.change_request;
...
class ChangeRequestController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        router.get("/api/v1/mes/work-center-assignments", &handleList);
        router.get("/api/v1/mes/work-center-assignments/*", &handleGet);
        router.post("/api/v1/mes/work-center-assignments", &handleCreate);
        router.put("/api/v1/mes/work-center-assignments/*", &handleUpdate);
        router.delete_("/api/v1/mes/work-center-assignments/*", &handleDelete);
    }
