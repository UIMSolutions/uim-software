module uim.platform.mes.presentation.http.controllers.health;

import uim.platform.mes;

@safe:

class MesHealthController : SAPController {
    ...
    private void handleRoot(scope HTTPServerRequest req, scope HTTPServerResponse res) {
        writeJsonBody(res, Json(["service": Json("Manufacturing Execution"), "status": Json("ok") ]));
    }
