module uim.platform.mes.presentation.http.controllers.product_structure;
...
class ProductStructureController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        router.get("/api/v1/mes/production-traceability", &handleList);
        router.get("/api/v1/mes/production-traceability/*", &handleGet);
        router.post("/api/v1/mes/production-traceability", &handleCreate);
        router.put("/api/v1/mes/production-traceability/*", &handleUpdate);
        router.delete_("/api/v1/mes/production-traceability/*", &handleDelete);
    }
