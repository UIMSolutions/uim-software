module uim.platform.mes.presentation.http.controllers.product;
...
class ProductController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        router.get("/api/v1/mes/production-orders", &handleList);
        router.get("/api/v1/mes/production-orders/*", &handleGet);
        router.post("/api/v1/mes/production-orders", &handleCreate);
        router.put("/api/v1/mes/production-orders/*", &handleUpdate);
        router.delete_("/api/v1/mes/production-orders/*", &handleDelete);
    }
    ...
    private void handleGet(scope HTTPServerRequest req, scope HTTPServerResponse res) {
        ...
        if (item is null) { writeError(res, 404, "Production order not found"); return; }
