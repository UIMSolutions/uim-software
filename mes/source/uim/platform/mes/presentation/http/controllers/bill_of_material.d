module uim.platform.mes.presentation.http.controllers.bill_of_material;
...
class BillOfMaterialController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        router.get("/api/v1/mes/operations", &handleList);
        router.get("/api/v1/mes/operations/*", &handleGet);
        router.post("/api/v1/mes/operations", &handleCreate);
        router.put("/api/v1/mes/operations/*", &handleUpdate);
        router.delete_("/api/v1/mes/operations/*", &handleDelete);
    }
