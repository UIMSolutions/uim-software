module uim.platform.mes.presentation.http.controllers.specification;
...
class SpecificationController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        router.get("/api/v1/mes/quality-inspections", &handleList);
        router.get("/api/v1/mes/quality-inspections/*", &handleGet);
        router.post("/api/v1/mes/quality-inspections", &handleCreate);
        router.put("/api/v1/mes/quality-inspections/*", &handleUpdate);
        router.delete_("/api/v1/mes/quality-inspections/*", &handleDelete);
    }
    ...
    private void handleGet(scope HTTPServerRequest req, scope HTTPServerResponse res) {
        ...
        if (item is null) { writeError(res, 404, "Quality inspection not found"); return; }
