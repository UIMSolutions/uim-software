module uim.platform.mes.presentation.http.controllers.document;
...
class DocumentController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        router.get("/api/v1/mes/shop-floor-events", &handleList);
        router.get("/api/v1/mes/shop-floor-events/*", &handleGet);
        router.post("/api/v1/mes/shop-floor-events", &handleCreate);
        router.put("/api/v1/mes/shop-floor-events/*", &handleUpdate);
        router.delete_("/api/v1/mes/shop-floor-events/*", &handleDelete);
    }
