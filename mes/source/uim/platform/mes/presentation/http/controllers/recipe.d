module uim.platform.mes.presentation.http.controllers.recipe;
...
class RecipeController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        router.get("/api/v1/mes/batch-records", &handleList);
        router.get("/api/v1/mes/batch-records/*", &handleGet);
        router.post("/api/v1/mes/batch-records", &handleCreate);
        router.put("/api/v1/mes/batch-records/*", &handleUpdate);
        router.delete_("/api/v1/mes/batch-records/*", &handleDelete);
    }
