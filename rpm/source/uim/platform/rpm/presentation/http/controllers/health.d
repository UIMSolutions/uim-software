module uim.platform.rpm.presentation.http.controllers.health;

import uim.platform.rpm;

@safe:

class RpmHealthController : SAPController {
    ...
    private void handleRoot(scope HTTPServerRequest req, scope HTTPServerResponse res) {
        ...
        payload["service"] = Json("Returnable Packaging Management");
