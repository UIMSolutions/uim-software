module uim.platform.ibp.presentation.http.controllers.document;
...
class DocumentController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        router.get("/api/v1/ibp/inventory-plans", &handleList);
        router.get("/api/v1/ibp/inventory-plans/*", &handleGet);
        router.post("/api/v1/ibp/inventory-plans", &handleCreate);
        router.put("/api/v1/ibp/inventory-plans/*", &handleUpdate);
        router.delete_("/api/v1/ibp/inventory-plans/*", &handleDelete);
    }
