module uim.platform.ibp.presentation.http.controllers.bill_of_material;
...
class BillOfMaterialController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        router.get("/api/v1/ibp/supply-plans", &handleList);
        router.get("/api/v1/ibp/supply-plans/*", &handleGet);
        router.post("/api/v1/ibp/supply-plans", &handleCreate);
        router.put("/api/v1/ibp/supply-plans/*", &handleUpdate);
        router.delete_("/api/v1/ibp/supply-plans/*", &handleDelete);
    }
