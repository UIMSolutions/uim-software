module uim.platform.ibp.presentation.http.controllers.collaboration;
...
class CollaborationController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        router.get("/api/v1/ibp/collaboration-workspaces", &handleList);
        router.get("/api/v1/ibp/collaboration-workspaces/*", &handleGet);
        router.post("/api/v1/ibp/collaboration-workspaces", &handleCreate);
        router.put("/api/v1/ibp/collaboration-workspaces/*", &handleUpdate);
        router.delete_("/api/v1/ibp/collaboration-workspaces/*", &handleDelete);
    }
