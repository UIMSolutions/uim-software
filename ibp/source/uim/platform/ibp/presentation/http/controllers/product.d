module uim.platform.ibp.presentation.http.controllers.product;
...
class ProductController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        router.get("/api/v1/ibp/demand-plans", &handleList);
        router.get("/api/v1/ibp/demand-plans/*", &handleGet);
        router.post("/api/v1/ibp/demand-plans", &handleCreate);
        router.put("/api/v1/ibp/demand-plans/*", &handleUpdate);
        router.delete_("/api/v1/ibp/demand-plans/*", &handleDelete);
    }
    ...
    private void handleGet(scope HTTPServerRequest req, scope HTTPServerResponse res) {
        ...
        if (item is null) { writeError(res, 404, "Demand plan not found"); return; }
