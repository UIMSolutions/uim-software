module uim.platform.ibp.presentation.http.controllers.change_request;
...
class ChangeRequestController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        router.get("/api/v1/ibp/response-plans", &handleList);
        router.get("/api/v1/ibp/response-plans/*", &handleGet);
        router.post("/api/v1/ibp/response-plans", &handleCreate);
        router.put("/api/v1/ibp/response-plans/*", &handleUpdate);
        router.delete_("/api/v1/ibp/response-plans/*", &handleDelete);
    }
