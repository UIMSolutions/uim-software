module uim.platform.ibp.presentation.http.controllers.recipe;
...
class RecipeController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        router.get("/api/v1/ibp/sop-cycles", &handleList);
        router.get("/api/v1/ibp/sop-cycles/*", &handleGet);
        router.post("/api/v1/ibp/sop-cycles", &handleCreate);
        router.put("/api/v1/ibp/sop-cycles/*", &handleUpdate);
        router.delete_("/api/v1/ibp/sop-cycles/*", &handleDelete);
    }
