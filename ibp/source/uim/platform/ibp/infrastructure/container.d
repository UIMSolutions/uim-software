module uim.platform.ibp.infrastructure.container;
...
struct Container {
    ...
    RunIbpIntegrationsUseCase runIbpIntegrationsUseCase;
    ...
    IbpHealthController healthController;
}
...
Container buildContainer(AppConfig config) {
    ...
    container.runIbpIntegrationsUseCase = new RunIbpIntegrationsUseCase(
        productRepo,
        specificationRepo,
    ...
    container.integrationController = new IntegrationController(container.runIbpIntegrationsUseCase);
    container.healthController = new IbpHealthController();
