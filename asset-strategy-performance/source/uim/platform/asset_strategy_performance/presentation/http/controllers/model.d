...
*****************************************************************************************************************/
module uim.software.asset_strategy_performance.presentation.http.controllers.model;
...
class ModelController : SAPController {
    ...
    override void registerRoutes(URLRouter router) {
        ...
        router.get("/api/v1/asset-strategy-performance/models", &handleList);
        router.get("/api/v1/asset-strategy-performance/models/*", &handleGet);
        router.post("/api/v1/asset-strategy-performance/models", &handleCreate);
        router.put("/api/v1/asset-strategy-performance/models/*", &handleUpdate);
        router.delete_("/api/v1/asset-strategy-performance/models/*", &handleDelete);
    }
    ...
    private void handleCreate(scope HTTPServerRequest req, scope HTTPServerResponse res) {
        try {
            ...
            dto.isoStandard = jsonStr(j, "isoStandard");
            dto.isPublished = jsonBool(j, "isPublished");
