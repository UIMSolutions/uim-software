...
*****************************************************************************************************************/
module uim.software.asset_strategy_performance.application.usecases.manage.manage_equipment;
...
class ManageEquipmentUseCase : UIMUseCase {
    ...
    Equipment[] listByLocation(LocationId locationId) {
    ...
    CommandResult create(EquipmentDTO dto) {
        ...
        e.maintenanceStrategy = dto.maintenanceStrategy;
        e.lastMaintenanceDate = dto.lastMaintenanceDate;
        e.nextMaintenanceDate = dto.nextMaintenanceDate;
        e.firmwareVersion = dto.firmwareVersion;
        e.createdBy = dto.createdBy;
        if (!StrategyValidator.isValidEquipment(e))
    ...
    CommandResult update(EquipmentDTO dto) {
        ...
        if (dto.maintenanceStrategy.length > 0) existing.maintenanceStrategy = dto.maintenanceStrategy;
